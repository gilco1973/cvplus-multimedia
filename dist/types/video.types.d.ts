import { MediaFile, ProcessedMedia, QualityLevel, VideoFormat, ImageFormat } from './media.types';
...
export type VideoFilterType = 'brightness' | 'contrast' | 'saturation' | 'hue' | 'blur' | 'sharpen' | 'noise_reduction' | 'deinterlace' | 'scale' | 'crop' | 'rotate' | 'flip' | 'fade_in' | 'fade_out' | 'watermark' | 'color_correction' | 'stabilization' | 'custom';
