...
export type CDNMetric = 'requests' | 'bandwidth' | 'cache-hit-rate' | 'response-time' | 'error-rate' | 'origin-requests' | 'data-transfer' | 'unique-visitors';
...
//# sourceMappingURL=cdn.types.d.ts.map