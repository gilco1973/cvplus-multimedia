...
export type AudioFilterType = 'equalizer' | 'compressor' | 'limiter' | 'gate' | 'reverb' | 'delay' | 'chorus' | 'flanger' | 'distortion' | 'overdrive' | 'bitcrusher' | 'highpass' | 'lowpass' | 'bandpass' | 'notch' | 'denoiser' | 'deesser' | 'exciter' | 'enhancer' | 'pitch_shift' | 'time_stretch' | 'reverse' | 'custom';
