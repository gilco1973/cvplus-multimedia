...
export type ProcessingJobType = 'image-processing' | 'video-transcoding' | 'audio-processing' | 'batch-processing' | 'format-conversion' | 'quality-optimization' | 'thumbnail-generation' | 'waveform-generation' | 'metadata-extraction';
...
export type PipelineStageType = 'input-validation' | 'format-detection' | 'preprocessing' | 'processing' | 'postprocessing' | 'quality-check' | 'output-generation' | 'cleanup';
...
export type NotificationEvent = 'job-started' | 'job-completed' | 'job-failed' | 'job-progress' | 'quality-issue' | 'performance-issue' | 'error-threshold-exceeded';
