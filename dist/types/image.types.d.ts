...
export type ResizeStrategy = 'cover' | 'contain' | 'fill' | 'inside' | 'outside';
...
export type WatermarkPosition = 'top-left' | 'top-center' | 'top-right' | 'middle-left' | 'middle-center' | 'middle-right' | 'bottom-left' | 'bottom-center' | 'bottom-right' | 'custom';
