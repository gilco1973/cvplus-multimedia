...
export type MultimediaErrorCategory = 'processing' | 'upload' | 'download' | 'storage' | 'cdn' | 'validation' | 'format' | 'quality' | 'resource' | 'network' | 'authentication' | 'authorization' | 'quota' | 'system';
...
export type RecoverySuggestionType = 'retry' | 'fallback' | 'alternative-method' | 'reduce-quality' | 'split-operation' | 'increase-resources' | 'contact-support' | 'wait' | 'manual-intervention';
...
export type RetryConditionType = 'error-code' | 'error-category' | 'http-status' | 'timeout' | 'network-error' | 'resource-unavailable' | 'temporary-failure' | 'custom';
...
export type StopConditionType = 'fatal-error' | 'authentication-failure' | 'authorization-failure' | 'validation-error' | 'quota-exceeded' | 'permanent-failure' | 'custom';
...
export type ProcessingStage = 'validation' | 'preprocessing' | 'processing' | 'postprocessing' | 'optimization' | 'output-generation';
