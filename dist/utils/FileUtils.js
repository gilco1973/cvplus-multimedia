...
export class FileUtils {
     ...
     */
    static isFileSizeValid(size, maxSize) {
        return size > 0 && size <= maxSize;
    }
    /**
     * Get supported file extensions for media type
     */
    static getSupportedExtensions(mediaType) {
        const extensions = [];
     ...
     */
    static generateDateBasedPath(filename, basePath = 'uploads') {
        const now = new Date();
     ...
     */
    static validateFile(file, criteria) {
        const errors = [];
        // Size validation
