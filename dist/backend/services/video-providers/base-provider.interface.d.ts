 ...
 */
export declare enum VideoProviderErrorType {
...
export declare class VideoProviderError extends Error {
    type: VideoProviderErrorType;
    providerId: string;
    retryable: boolean;
    originalError?: any;
    constructor(type: VideoProviderErrorType, message: string, providerId: string, retryable?: boolean, originalError?: any);
}
/**
 ...
 */
export declare abstract class BaseVideoProvider implements VideoGenerationProvider {
...
//# sourceMappingURL=base-provider.interface.d.ts.map